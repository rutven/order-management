...
export const OrderEntityDetail = (props: IOrderEntityDetailProps) => {
  useEffect(() => {
  ...
  return (
    <Row>
      <Col md="8">
        ...
        <Button tag={Link} to="/order-entity" replace color="info">
        ...
        &nbsp;
        <Button tag={Link} to={`/order-entity/${orderEntityEntity.id}/edit`} replace color="primary">
...
export default connect(mapStateToProps, mapDispatchToProps)(OrderEntityDetail);
