...
export interface IOrderEntityUpdateState {
  isNew: boolean;
}

export class OrderEntityUpdate extends React.Component<IOrderEntityUpdateProps, IOrderEntityUpdateState> {
  constructor(props) {
    super(props);
    this.state = {
  ...
  handleClose = () => {
    this.props.history.push('/entity/order-entity');
  };

  render() {
    const { orderEntityEntity, loading, updating } = this.props;
          ...
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : orderEntityEntity} onSubmit={this.saveEntity}>
                ...
                <Button tag={Link} id="cancel-save" to="/entity/order-entity" replace color="info">
