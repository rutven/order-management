...
import name.legkodymov.orders.config.Constants;
import name.legkodymov.orders.domain.Authority;
import name.legkodymov.orders.domain.User;
import name.legkodymov.orders.repository.AuthorityRepository;
import name.legkodymov.orders.repository.UserRepository;
import name.legkodymov.orders.security.AuthoritiesConstants;
import name.legkodymov.orders.service.UserService;
import name.legkodymov.orders.service.dto.PasswordChangeDTO;
import name.legkodymov.orders.service.dto.UserDTO;
import name.legkodymov.orders.web.rest.vm.KeyAndPasswordVM;
import name.legkodymov.orders.web.rest.vm.ManagedUserVM;
...
import static name.legkodymov.orders.web.rest.AccountResourceIT.TEST_USER_LOGIN;
